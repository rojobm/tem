(function(){
	...
	var solbasica2= {
		controller:solbasica2Ctrl,
		templateUrl:'app/componentes/component_sol_basica/sol_basica2.html',
	}

	angular
		.module('bueno')
		.component('solBasica2',solbasica2);

	    function solbasica2Ctrl($scope, $firebaseObject){
	    	var prac= this;
